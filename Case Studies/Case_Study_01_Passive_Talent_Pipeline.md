...
| Sourcing Approach | Competitor mapping, Boolean search, passive engagement, referrals |
| Duration | 4 Weeks |
| Team | Talent Acquisition |
| Status | Portfolio Case Study (Fictional, inspired by real-world recruiting experience) |

> **Portfolio Note:** This is a fictional scenario inspired by my professional experience in full-cycle recruitment, written for portfolio purposes. No confidential employer or candidate information is included.
...
- Build a passive pipeline that didn't rely on the same crowded inbound channels everyone else was fishing from
- Give the hiring manager enough market context to calibrate expectations, rather than holding out for a "perfect" candidate who may not exist
- Bring time-to-fill down meaningfully without cutting corners on screening
- Keep candidates engaged through what was likely to be a long, competitive process
- Land the hire inside the SLA the delivery team was counting on
...
| Week | Milestone |
|------|-----------|
| Week 1 | Requirement intake, stakeholder alignment, market research, hiring strategy reset |
| Week 2 | Talent mapping completed, sourcing executed, passive outreach begins |
| Week 3 | Screening, interview coordination, calibration with hiring manager |
| Week 4 | Offer management, candidate engagement, closure, retrospective |
...
|-------------|---------------|
| Hiring Manager | Defined the technical bar and interview criteria |
| Delivery Leadership | Made the urgency and business stakes explicit early on |
| Talent Acquisition (me) | Owned sourcing strategy, market intelligence, and candidate engagement end-to-end |
| Interview Panel | Ran competency-based technical rounds |
| HR Operations | Handled offer paperwork and onboarding logistics |
...
A few things from the market intelligence tracker shaped how I ran this: referral-sourced candidates were converting noticeably better than cold outreach, notice periods across this talent segment were running long enough that I needed to start conversations earlier than usual, and personalized messaging (naming the actual project, not just "exciting opportunity") was getting real replies instead of silence.
...
Two of my strongest candidates picked up competing offers mid-process, which meant compressing our own interview timeline faster than I'd have liked. Notice periods also meant a couple of good conversations early on simply couldn't turn into near-term hires, no matter how interested the candidate was — that's a genuine limitation of this kind of role, not something you source your way around. Scheduling across three time zones for the panel added its own friction, and a couple of interview slots had to be reshuffled twice.

None of this was dramatic, but it's the kind of thing that eats a week if you don't stay on top of it.
...
| Offer-to-Interview Ratio | Baseline | Up 38% |
| Offer-to-Joining Ratio | 90% | 90% (held steady despite a tighter market) |
| SLA Compliance | At risk | Met |

Beyond the hire itself, the talent map built for this role didn't go to waste — it's now the starting point for the next Solution Architect requisition, so the next search shouldn't need to start from zero.
...
Full-cycle recruitment, passive sourcing, talent mapping, market research, Boolean search, competitor mapping, stakeholder management, interview coordination, offer management, and recruitment analytics.
